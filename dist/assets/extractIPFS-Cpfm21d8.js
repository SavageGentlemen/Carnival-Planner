import { B as isHex, at as hexToBytes } from "./index-CXUot43X.js";
...
const iFACTOR = /* @__PURE__ */ (() => Math.log(256) / Math.log(BASE))();
...
class Decoder {
  ...
  decode(source, end = -1) {
    ...
    if (this instanceof Decoder) {
      currentDecoder = this;
      this.sharedValues && (this.pack ? new Array(this.maxPrivatePackedValues || 16).concat(this.sharedValues) : this.sharedValues);
