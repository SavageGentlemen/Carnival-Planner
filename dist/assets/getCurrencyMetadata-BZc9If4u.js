const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CXUot43X.js","assets/vendor-3d-C6aqP7jv.js","assets/vendor-maps-DCMhh9kT.js","assets/vendor-swr-BEHUV5vo.js","assets/vendor-firebase-core-DHwGrt-V.js","assets/vendor-firebase-data-O6IN0zfq.js","assets/index-ByoYVoQD.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./vendor-3d-C6aqP7jv.js";
import { r as readContract, G as isNativeTokenAddress } from "./bundler-Dmn5v2kr.js";
import { V as withCache } from "./index-CXUot43X.js";
import { d as decimals } from "./decimals-RuAU2I0v.js";
...
ZodOptional.create;
ZodNullable.create;
const FN_SELECTOR$1 = "0x06fdde03";
const FN_INPUTS$1 = [];
const FN_OUTPUTS$1 = [
  {
    type: "string"
...
async function name(options) {
  return withCache(() => name$1(options), {
...
async function symbol$1(options) {
  return readContract({
    contract: options.contract,
...
async function symbol(options) {
  return withCache(() => symbol$1(options), {
    cacheKey: `${options.contract.chain.id}:${options.contract.address}:symbol`,
    // can never change, so cache forever
    cacheTime: Number.POSITIVE_INFINITY
  });
}
const NATIVE_CURRENCY_SCHEMA = objectType({
  name: stringType().default("Ether"),
  symbol: stringType().default("ETH"),
  decimals: numberType().default(18)
}).default({
  name: "Ether",
  symbol: "ETH",
  decimals: 18
