...
const DEMO_CARNIVALS = {
  trinidad: {
    name: "Trinidad Carnival - February",
    shareCode: "FETE26",
    sharedPlanId: "demo-plan-id",
    budget: [
      { id: "1", name: "Flight (JFK -> POS)", cost: 850, addedBy: { email: "guest@carnival.com" } },
      { id: "2", name: "Airbnb (Woodbrook)", cost: 1200, addedBy: { email: "soca@junkie.com" } },
      { id: "3", name: "Costume Deposit", cost: 300, addedBy: { email: "guest@carnival.com" } },
      { id: "4", name: "Spending Money", cost: 500, addedBy: { email: "guest@carnival.com" } }
    ],
    schedule: [
