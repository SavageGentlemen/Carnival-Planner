...
export {
  ...
  signInAnonymously as H,
  signInWithCustomToken as I,
  signInWithEmailAndPassword as J,
  signInWithEmailLink as K,
  Logger as L,
  signInWithPhoneNumber as M,
  unlink as N,
  OAuthProvider as O,
  updateEmail as P,
  updatePassword as Q,
  ...
  updateProfile as U,
  connectAuthEmulator as V,
  verifyBeforeUpdateEmail as W,
  signInWithRedirect as X,
  signInWithPopup as Y,
  linkWithRedirect as Z,
  _registerComponent as _,
  LogLevel as a,
  linkWithCredential as a0,
  OAuthCredential as a1,
  getAdditionalUserInfo as a2,
  inMemoryPersistence as a3,
  indexedDBLocalPersistence as a4,
  browserSessionPersistence as a5,
  browserLocalPersistence as a6,
  signOut as a7,
  ErrorFactory as a8,
  openDB as a9,
  deleteDB as aa,
  validateIndexedDBOpenable as ab,
  areCookiesEnabled as ac,
  initializeApp as ad,
  onAuthStateChanged as ae,
  signInWithCredential as af,
  __assign as ag,
  __rest as ah,
  __spreadArray as ai,
  _getProvider as b,
  isIndexedDBAvailable as c,
  deepEqual as d,
  ...
  getApp as h,
  isSafari as i,
  getDefaultEmulatorHostnameAndPort as j,
  _removeServiceInstance as k,
  getAuth as l,
  applyActionCode as m,
  createUserWithEmailAndPassword as n,
  confirmPasswordReset as o,
  deleteUser as p,
  fetchSignInMethodsForEmail as q,
  registerVersion as r,
  getRedirectResult as s,
  isSignInWithEmailLink as t,
  FacebookAuthProvider as u,
  GoogleAuthProvider as v,
  linkWithPhoneNumber as w,
  reload as x,
  revokeAccessToken as y,
  sendEmailVerification as z
};
