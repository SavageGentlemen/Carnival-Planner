import { _ as BaseError } from "./index-CXUot43X.js";
import { s as stringify } from "./bundler-Dmn5v2kr.js";
...
class SocketClosedError extends BaseError {
  constructor({ url } = {}) {
...
export {
  ...
  InternalRpcError as I,
  JsonRpcVersionUnsupportedError as J,
  LimitExceededRpcError as L,
  MethodNotFoundRpcError as M,
  ParseRpcError as P,
  RpcRequestError as R,
  SwitchChainError as S,
  TimeoutError as T,
  UserRejectedRequestError as U,
  WebSocketRequestError as W,
  SocketClosedError as a,
  TransactionRejectedRpcError as b,
  AtomicityNotSupportedError as c,
  InvalidInputRpcError as d,
  InvalidParamsRpcError as e,
  InvalidRequestRpcError as f,
  getUrl as g,
  MethodNotSupportedRpcError as h,
  ProviderDisconnectedError as i,
  ProviderRpcError as j,
  ResourceNotFoundRpcError as k,
  ResourceUnavailableRpcError as l,
  RpcError as m,
  UnauthorizedProviderError as n,
  UnknownBundleIdError as o,
  UnknownRpcError as p,
  UnsupportedChainIdError as q,
  UnsupportedNonOptionalCapabilityError as r,
  UnsupportedProviderMethodError as s,
  getContractAddress as t
};
