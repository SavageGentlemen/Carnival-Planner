import { L as Logger, _ as _registerComponent, C as Component, r as registerVersion, F as FirebaseError, a as LogLevel, b as _getProvider, d as deepEqual, i as isSafari, g as getUA, c as isIndexedDBAvailable, e as getModularInstance, f as createMockUserToken, h as getApp, j as getDefaultEmulatorHostnameAndPort, k as _removeServiceInstance, S as SDK_VERSION } from "./vendor-firebase-core-DHwGrt-V.js";
...
class __PRIVATE_SimpleDb {
  ...
  static D() {
    ...
    if (__PRIVATE_SimpleDb.v()) return true;
...
class __PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 17) {
    ...
    this.di = (e2) => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.D()) throw new FirestoreError(D.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
...
export {
  ...
  initializeFirestore as n,
  onSnapshot as o,
  persistentLocalCache as p,
  query as q,
  ref as r,
  setDoc as s,
  getStorage as t,
  uploadBytes as u,
  persistentMultipleTabManager as v,
  where as w,
  arrayUnion as x,
  arrayRemove as y,
  deleteField as z
